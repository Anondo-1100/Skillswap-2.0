...
import { Home, ArrowLeft, AlertCircle
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-6xl font-bold text-red-600 dark:text-red-400">{code
  }</h1>
        <h2 className="mt-4 text-3xl font-bold text-gray-900 dark:text-white">{title
  }</h2>
